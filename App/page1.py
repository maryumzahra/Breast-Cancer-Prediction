...
def clean_data():
    data = pd.read_csv(r'E:\VS Code\Git Repos\Breast-Cancer-Prediction\Data\data.csv')
...
def dynamic_donut_chart(input_data):
    model = pickle.load(open(r'E:\VS Code\Git Repos\Breast-Cancer-Prediction\Model\model.pkl', 'rb'))
    scaler = pickle.load(open(r'E:\VS Code\Git Repos\Breast-Cancer-Prediction\Model\scaler.pkl', 'rb'))
