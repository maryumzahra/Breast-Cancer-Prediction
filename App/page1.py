...
def clean_data():
    data = pd.read_csv(r'C:\Users\saada\Desktop\saad\Breast-Cancer-Prediction\Data\data.csv')
...
def dynamic_donut_chart(input_data):
    ...
    model = pickle.load(open(r'C:\Users\saada\Desktop\saad\Breast-Cancer-Prediction\Model\model.pkl', 'rb'))
    scaler = pickle.load(open(r'C:\Users\saada\Desktop\saad\Breast-Cancer-Prediction\Model\scaler.pkl', 'rb'))
...
def main():
    ...
    with col1:
        ...
        st.subheader('Malignant vs Benign Probabilities')
        donut_chart = dynamic_donut_chart(input_data)
