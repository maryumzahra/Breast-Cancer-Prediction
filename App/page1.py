...
def main():
     ...
     with col3:
        ...
        # Chatbot section
        chatbot()
     st.write('**Note:** The results generated by this tool should be interpreted by qualified medical practitioners and should not be considered as a definitive diagnosis.')
